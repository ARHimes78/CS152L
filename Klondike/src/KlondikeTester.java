...
public class KlondikeTester {
    ...
    public static void testIsBlack() {
        countTest(new Card(Rank.FOUR, Suit.CLUBS).isBlack());
        countTest(new Card(Rank.FOUR, Suit.SPADES).isBlack());
        countTest(!new Card(Rank.FOUR, Suit.HEARTS).isBlack());
        countTest(!new Card(Rank.FOUR, Suit.DIAMONDS).isBlack());
    }
    ...
    public static void testGetTop() {
        Deck deck = new Deck();
        countTest(null == deck.getTop());
        deck.add(new Card(Rank.FIVE, Suit.DIAMONDS));
        Card c = new Card(Rank.SIX, Suit.DIAMONDS);
        deck.add(c);
        countTest(c == deck.getTop());
    }
    ...
    public static void testImageFilename() {
        ...
        java.nio.file.Path path = java.nio.file.Paths.get(faceDownName);
        countTest(java.nio.file.Files.isReadable(path));
        path = java.nio.file.Paths.get(faceUpName);
        countTest(java.nio.file.Files.isReadable(path));
    }
    ...
    public static void main(String[] args) {
        ...
        clearCounts();
        System.out.println("testIsBlack");
        testIsBlack();
        correct+= correctTests;
        total += totalTests;
        System.out.println("  Passed " + correctTests + " of " + totalTests);
