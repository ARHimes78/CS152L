...
public class BookTest {
    ...
    public static void main(String[] args) { 
        ...
        if( BookConstants.UNKNOWN_YEAR == a2.getDeath() ) { tScore++; }
        ...
        if( BookConstants.UNKNOWN_YEAR   == allTheBooks[2].getPubYear() ) { tScore++; }
        if( BookConstants.UNKNOWN_AUTHOR == allTheBooks[3].getAuthor() ) { tScore++; }
        if( BookConstants.UNKNOWN_AUTHOR == allTheBooks[4].getAuthor() ) { tScore++; }
        if( BookConstants.UNKNOWN_TITLE  == allTheBooks[3].getTitle() ) { tScore++; }
        if( BookConstants.UNKNOWN_ISBN   == allTheBooks[0].getISBN() ) { tScore++; }
